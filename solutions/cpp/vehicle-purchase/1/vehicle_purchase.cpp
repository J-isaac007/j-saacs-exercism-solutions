...
double calculate_resell_price(double original_price, double age) {
    ...
    if (age < 3) return static_cast<double>(original_price * 0.80);
    else if (age >= 3 && age < 10) return static_cast<double>(original_price * 0.70);
    else return static_cast<double>(original_price * 0.50);
}
